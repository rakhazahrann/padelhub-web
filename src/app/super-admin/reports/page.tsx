...
export default function SuperAdminReportsPage() {
  ...
  const handleExportCsv = async () => {
    try {
      ...
      a.href = url;
      a.download = `laporan-global-${range}-hari.csv`;
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Analisis performa seluruh venue dan booking di sistem PadelHub
          </p>
        </div>
          ...
          <div className="rounded-xl border border-border bg-card p-5 ring-1 ring-foreground/5 shadow-sm">
            <div className="mb-5">
              ...
              <p className="text-xs text-muted-foreground">
                Grafik pendapatan semua venue dalam {range === '7' ? '7' : '30'} hari terakhir
              </p>
            </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="rounded-xl border border-border bg-card p-5 ring-1 ring-foreground/5 shadow-sm">
            <div className="mb-5">
              <h3 className="text-base font-semibold">Okupansi Global</h3>
              <p className="text-xs text-muted-foreground">
                Tingkat okupansi semua venue dalam {range === '7' ? '7' : '30'} hari terakhir
              </p>
            </div>
